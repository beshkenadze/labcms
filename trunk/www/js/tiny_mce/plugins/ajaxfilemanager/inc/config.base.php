...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	//FILESYSTEM CONFIG
		...
		*/
    define('CONFIG_SYS_DEFAULT_PATH', '../../../../storage/'); 
	define('CONFIG_SYS_ROOT_PATH', '../../../../storage/');	//the root folder where the files would be uploaded to
	define("CONFIG_SYS_DIR_SESSION_PATH", '../../../../cache/');
	...
	define('CONFIG_UPLOAD_OVERRIDE_ALLOWED', 1);
